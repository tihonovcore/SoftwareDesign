...
//        String pathToStatistics = "/home/tihonovcore/IdeaProjects/SoftwareDesign/aop/target/statistics.txt";
    ...
    private void run(
        ...
        compile();
        // TODO: need to remove copy of profiler, but ajc exit from application before it
        removeProfiler(pathToPackage, packageName);
    }
    ...
    private void removeProfiler(String pathToPackage, String packageName) throws IOException {
        Files.delete(Paths.get(pathToPackage + packageName.replace('.', '/') + "/AspectProfiler.java"));
    }
}
